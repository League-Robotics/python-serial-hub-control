...
<https://github.com/League-Robotics/python-serial-hub-control/wiki>

The League Robotics docs hub *clones the wiki* and publishes it at
<https://league-robotics.github.io/subsystems/python-serial-hub-control/>. The hub never writes back here —
